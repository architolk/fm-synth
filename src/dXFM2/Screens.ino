...
const uint8_t ALGOPOS[32][8] = {
  ...
  {0b00011011,0b00010011,0b10001011,0b00011100,0b01010100,0b00010101,1,4}, //10
  {0b00011011,0b00010011,0b00001011,0b00011100,0b01010100,0b10010101,1,4}, //11
  ...
  {0b00011010,0b00011011,0b10010011,0b00011101,0b01010100,0b00010101,3,4}, //20
  ...
  {0b00011001,0b00011010,0b00010010,0b00011101,0b01010100,0b10010101,4,4}, //26
  {0b00011001,0b00011010,0b10010010,0b00011101,0b01010100,0b00010101,4,4}, //27
...
void drawOperatorBox(uint8_t x, uint8_t y, uint8_t l, uint8_t nr, bool feedback) {
...
void showAlgorithmMenuOnScreen(uint8_t nr, const String& param, uint8_t algo, uint8_t screen) {
  ...
  for (uint8_t op=0; op<6; op++) {
    drawOperatorBox(6+(ALGOPOS[algo][op] & 0b111)*20,6+((ALGOPOS[algo][op] & 0b11000)/8)*14,5-(ALGOPOS[algo][op] & 64)/32,op+1,(ALGOPOS[algo][op] & 128)==128);
  }
  if (ALGOPOS[algo][6]>0) {
