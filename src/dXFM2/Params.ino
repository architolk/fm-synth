...
const uint16_t PARAMMAP[6][6][7] PROGMEM = {
  { //0 & 8, LFO
    ...
    {1046,1047,1048,1049,1050,1051,180},
  ...
  {  //2 & 6, Operators
    ...
    {4103,4110,4117,4089,4124,4199,4187},
    {4075,4082,4089,4089,4096,4193,4181}
  },
  { //3 & 5, Effects
    {0,380,370,321,320,410,0},
    {366,362,365,364,362,361,360},
    {0,393,0,394,392,391,390},
    {1053,314,315,313,1020,311,310},
    {1019,1052,304,1018,302,301,300},
    {331,333,0,0,330,332,0}
  },
  { //4, Master
...
const uint16_t PARAMEXMAP[54][2] PROGMEM = {
  ...
  {306,305},{308,309},{312,317}, //EFX 1018-1020
