...
//Menu has 8 items (MENUCOUNT) and 128 patches are possible, so max values 7 and 127
uint8_t encoderMax[10] = {255,255,255,255,255,255,255,7,255,127}; //Default maximum values for an encoder
